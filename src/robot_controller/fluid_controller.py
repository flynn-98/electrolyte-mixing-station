...
class fluid_handler:
    ...
    def add_electrolyte(self, fluid_vol: float, tube_length: float = 350.0, overpump: float = 1.2) -> None:
    ...
    def clean_cell(self, fluid_vol: float, tube_length: float = 350.0, overpump: float = 1.2) -> None:
